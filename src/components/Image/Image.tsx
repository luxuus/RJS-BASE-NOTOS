...
const Image: FC<ImageProps> = ({
  ...
  const handleError = useCallback<NonNullable<React.ImgHTMLAttributes<HTMLImageElement>['onError']>>(
    (e) => {
  ...
  return (
    <ImageWrapper
      className={className}
      style={{ ...style, width, height, ['--img-radius' as any]: radius, ['--img-fit' as any]: fit, ['--img-ratio' as any]: aspectRatio ?? 'auto' }}
